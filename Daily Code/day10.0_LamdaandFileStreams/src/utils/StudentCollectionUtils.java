...
public class StudentCollectionUtils {
	private static int index = 0;
	 ...
	 public static List<Student> populateList() {
		...
		index=0; //reset indexing for multiple invoking of the method.
	...
	//
	public static void writeDetails(Stream<Student> students,String fileName) throws java.io.IOException
	{
