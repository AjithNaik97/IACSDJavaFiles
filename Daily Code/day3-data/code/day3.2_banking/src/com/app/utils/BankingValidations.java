...
//add public static method to validate all inputs
	public static BankAccount validateInputs(int accNo,String fName, String lastName, String acType, String dob, String creationDate, double balance) throws BankingException
	{
		...
		//=> all i/ps are valid
		return new BankAccount(accNo,fName,lastName,acType, dob, creationDate, balance);
		return null;
	}
