		...
		try (Scanner sc = new Scanner(System.in)) {
			...
			while (!exit) {
				...
				try {
					...
					case 3:
						System.out.println("Enter the account no to be checked: ");
						System.out.println(findAccountdetail(sc.nextInt(),accounts));
						break;
						
					case 4:
						System.out.println("Enter the account no and amount to be withdraw. ");
						BankAccount account=findAccountdetail(sc.nextInt(),accounts);
