...
//add public static method to validate for min bal
	...
	// Search for the matching account using account number
	public static BankAccount findAccountdetail(int acctNo, BankAccount[] accts) throws BankingException
	{
		BankAccount acct=new BankAccount(acctNo);
		for(BankAccount a:accts) {
			if(a!=null && a.equals(acct))
		...
		throw new BankingException("Account does not exists!");
	}
