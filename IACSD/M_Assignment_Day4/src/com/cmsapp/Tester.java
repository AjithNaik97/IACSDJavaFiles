...
public class Tester {
	...
	public static void main(String[] args) {
		...
		try (Scanner sc = new Scanner(System.in)) {
			...
			while (!exit) {
				System.out.println(
						"1.Sign Up 2.Sign In 3.Reset Login password 4.Unsubscribe Customer 5.Display all Details 6.Sort in ascending order of email 7.Display customer details sorted as per the dob n last name 8.Remove all customer details from specified plan born after specified date. 0.Exit");
