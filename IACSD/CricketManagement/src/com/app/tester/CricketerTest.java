				...
				try {
					...
					case 1:
						for(int i=0;i<5;i++) {
							...
							Cricketer c = Validations.inputvalidations(sc.next(), sc.nextInt(), sc.next(), sc.next(),
									sc.nextInt(), cricketersmap);
					...
					case 5:
						List<Cricketer> sortedList = CricketUtils.sortByRating(cricketersmap);
